...
$leaderboard = $conn->query("SELECT s.Student_id, s.Fname, s.Lname, s.dept_id, SUM(r.Points_Awarded) as total_points FROM Reward_Points r JOIN Student s ON r.Student_id=s.Student_id GROUP BY s.Student_id, s.Fname, s.Lname, s.dept_id ORDER BY total_points DESC LIMIT 20");
    ...
    <div class="page-content">
        ...
        <div class="card">
            ...
            <div class="table-wrapper">
                <table>
                    <thead><tr><th>Rank</th><th>Student</th><th>Department</th><th>Total Points</th><th>Achievement</th></tr></thead>
                    <tbody>
